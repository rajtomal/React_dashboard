        ...
        <>
            <section className='page-main'>
                <div className='page-title'>
                    <h2>Department</h2>
                    <button onClick={handleShow} className='add-btn'><Icon icon="ic:round-add" width="20" height="20" /> <span>Create Department</span></button>
                </div>
                <div className='page-content'>
                    ...
                    <Modal show={show} onHide={handleClose}>
                        <Modal.Header closeButton>
                            <Modal.Title>{createUpdate ? 'Create Department' : 'Update Department'}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <div className='mb-3'>
