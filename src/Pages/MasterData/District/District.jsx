...
const data = [
    {
        ...
        countryDescription: 'lorem ipsumr',
    },
    {
        id: 2,
        countryName: 'Albania',
        countryDescription: 'lorem ipsum34',
    },
    {
        id: 3,
        countryName: 'Algeria',
        countryDescription: 'lorem ipsum43',
    },
]
        ...
        <>
            <section className='page-main'>
                <div className='page-title'>
                    <h2>District</h2>
                    <button onClick={handleShow} className='add-btn'><Icon icon="ic:round-add" width="20" height="20" /> <span>Create District</span></button>
                </div>
                <div className='page-content'>
                    ...
                    <Modal show={show} onHide={handleClose}>
                        <Modal.Header closeButton>
                            <Modal.Title>{createUpdate ? 'Create District' : 'Update District'}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <div className='mb-3'>
