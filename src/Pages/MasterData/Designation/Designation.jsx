        ...
        <>
            <section className='page-main'>
                <div className='page-title'>
                    <h2>Designation</h2>
                    <button onClick={handleShow} className='add-btn'><Icon icon="ic:round-add" width="20" height="20" /> <span>Create Designation</span></button>
                </div>
                <div className='page-content'>
                    ...
                    <Modal show={show} onHide={handleClose}>
                        <Modal.Header closeButton>
                            <Modal.Title>{createUpdate ? 'Create Designation' : 'Update Designation'}</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <div className='mb-3'>
