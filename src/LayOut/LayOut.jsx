...
const LayOut = () => {
    ...
    const menu = [
        ...
        },
        {
            ...
            icon: 'material-symbols:dashboard-outline',
            path: null,
            subMenu: [{ id: 11, name: 'About', icon: 'material-symbols:dashboard-outline', path: '/about' },
            { id: 12, name: 'ddd', icon: 'material-symbols:dashboard-outline', path: '/ddd' },]
        },
        {
            id: 3,
            name: 'Settings',
                        ...
                        <div>
                            {menu.map((item) => (
                                <React.Fragment key={item.id}>
                                    ...
                                    {item.subMenu.length > 0 && item.subMenu.map((i) => (
                                        (openSideBar && <Collapse key={i.id} in={openMenu[item.id]} timeout="auto" unmountOnExit>
